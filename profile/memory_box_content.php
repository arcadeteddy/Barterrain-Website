...
////////// SUBSCRIPTIONS!!! //////////
$mysql_union = mysql_query("(SELECT id, post_date AS datetime, union_type FROM posts WHERE ((user_page_id='$id')AND((memory_type='b')OR(memory_type='d'))) 
...
$(window).data('ajaxready7', true).scroll(function()
	...
	if($(window).scrollTop()>=$("#bottom_memory_box").height()-$(document).height())
		...
		$.ajax({cache: false,url:"memory_box_content.php?number="+number+"&cacheBuster="+cacheBuster+"&id="+id+"&ids="+ids,
