...
function albums_list(a,b,c)
	{$.post("albums_list.php?page="+a,{x:a,id:b,ids:c},function(data) 
		{$("#albums_list").html(data).show()});	
	}
function games_list(a,b,c)
	{$.post("games_list.php?page="+a,{x:a,id:b,ids:c},function(data) 
		{$("#games_list").html(data).show()});	
	}	
function videos_list(a,b,c)
	{$.post("videos_list.php?page="+a,{x:a,id:b,ids:c},function(data) 
...
function removeAsFriend(a,b)
	{$.post(friendRequestURL,{request:"removeFriendship",id:id,ids:ids,user_id:a,request_id:b,thisWipit:thisRandNum},function(data) 
		{$("body").html(data).show()});	
	}
function removeAsFriend_family(a,b)
	{$.post(friendRequestURL,{request:"removeFriendship2",list:"family",id:id,ids:ids,user_id:a,request_id:b,thisWipit:thisRandNum},function(data) 
		{$("#family_list").html(data).show()});	
	}
function removeAsFriend_friends(a,b)
	{$.post(friendRequestURL,{request:"removeFriendship2",list:"friends",id:id,ids:ids,user_id:a,request_id:b,thisWipit:thisRandNum},function(data) 
...
function unsubscribeUser_subscribers(a,b)
	{$.post(friendRequestURL,{request:"unsubscribeUser2",list:"subscribers",id:id,ids:ids,subscriber_id:a,user_id:b,thisWipit:thisRandNum},function(data) 
		{$("#subscribers_list").html(data).show()});	
	}
function unsubscribeUser_subscriptions(a,b)
	{$.post(friendRequestURL,{request:"unsubscribeUser2",list:"subscriptions",id:id,ids:ids,subscriber_id:a,user_id:b,thisWipit:thisRandNum},function(data) 
...
function Like_folder(a,b,c,d)
	{$.post(like_loveURL,{like_love:"Like_folder",id:a,ids:b,item_id:c,item_type:d,thisWipit:thisRandNum},function(data) 
		{$("#like_love_"+d+c).html(data).show()});	
	}
function Love_folder(a,b,c,d)
	{$.post(like_loveURL,{like_love:"Love_folder",id:a,ids:b,item_id:c,item_type:d,thisWipit:thisRandNum},function(data) 
		{$("#like_love_"+d+c).html(data).show()});	
	}
function unlikeLike_folder(a,b,c,d)
	{$.post(like_loveURL,{like_love:"unlikeLike_folder",id:a,ids:b,item_id:c,item_type:d,thisWipit:thisRandNum},function(data) 
		{$("#like_love_"+d+c).html(data).show()});
	}
function unloveLove_folder(a,b,c,d)
	{$.post(like_loveURL,{like_love:"unloveLove_folder",id:a,ids:b,item_id:c,item_type:d,thisWipit:thisRandNum},function(data) 
		{$("#like_love_"+d+c).html(data).show()});
	}
...
function comment_form(a,b)
	...
	if (comment_field.val() == '')
		{$("#top_result_div2").html('<font class="color" style="font:12px helvetica, sans-serif;">Comment field is empty. <br/>Please write something!</font><br/><br/>').show();}
	else
...
function delete_folder1(a,b)
	{$.post(interactiveURL,{item_id:a,item_type:b,interactive:"delete_folder1"},function(data) 
		{$("#delete_folder_"+b+a).html(data).show();});}
function delete_folder2(a,b)
	{$.post(url,{id:id,ids:ids,item_id:a,item_type:b,interactive:"delete_folder2",thisWipit:thisRandNum},function(data) 
...
$(document).ready(function () 
	{var $sidebar = $("#profile_page_left "),
    $window = $(window),
    sidebartop = $("#profile_page_left").position().top;
...
$(function()
	{var planet_side = $('#profile_page_right_covers');
    var planet_sidePosTop = planet_side.offset().top;
    var win = $(window);
    win.scroll(function(e)
		{var scrollTop = win.scrollTop();
        if (scrollTop >= planet_sidePosTop-32)
			{planet_side.css({position:'fixed',top:'0px',marginTop:'32px'});}
		else if (planet_side.css('position') === 'fixed')
			{planet_side.css({position:'',top:'0px',marginTop:'0px'});}
    });
});
