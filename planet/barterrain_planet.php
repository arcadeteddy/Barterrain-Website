...
// Cover Picture
$mysql_cover = mysql_query("SELECT cover_picture_ext FROM planets WHERE id='$id' LIMIT 1");
...
div.planet_page_body{float:left;width:1060px;position:absolute;margin:0px 60px;min-height:100%;}
div.planet_page_body_cover{text-align:left;width:1180px;margin:0 auto;overflow:hidden;}
div.planet_page_body_left{position:fixed;width:30px;margin-left:235px;background:url('../barterrain_main_images/side_shadows.png') -0px -0px;background-repeat:repeat-y;height:100%;z-index:-2;}
div.planet_page_body_right{position:fixed;width:30px;margin-left:1120px;background:url('../barterrain_main_images/side_shadows.png') -30px -0px;background-repeat:repeat-y;height:100%;z-index:-2;}
div.planet_page_left{float:left;text-align:center;width:265px;z-index:6;overflow:hidden;}
div.planet_page_right{float:right;text-align:left;height:100%;width:793px;border-left-style:solid;border-right-style:solid;border-color:<?php echo $color2; ?>;border-width:1px;position:relative;z-index:3;}
div.planet_page_middle_left{overflow:hidden;text-align:left;float:left;width:490px;padding:19px;border-right-style:solid;border-color:<?php echo $color2; ?>;border-width:1px;}
div.planet_page_middle_left.expand{overflow:hidden;text-align:left;float:left;width:755px;padding:19px;border-right-style:solid;border-color:<?php echo $color2; ?>;border-width:1px;}
div.planet_page_middle_right{overflow:hidden;text-align:left;right:right;width:264px;}
...
img.planet_image{border-right-style:solid;border-right-width:2px;border-top-style:solid;border-bottom-style:solid;border-left-style:solid;border-width:3px;border-color:<?php echo $color2; ?>;position:relative;z-index:6;}
img.planet_header{width:16px;height:17px;background:url('barterrain_planet_images/planet_images.png') -68px 0px;margin-right:6px;}
img.planet_wall{vertical-align:top;width:15px;height:15px;background:url('barterrain_planet_images/planet_images.png') 0px 0px;}
img.planet_info{width:16px;height:15px;background:url('barterrain_planet_images/planet_images.png') -17px 1px;}
img.planet_media{width:16px;height:15px;background:url('barterrain_planet_images/planet_images.png') -34px 1px;}
img.planet_notes{width:15px;height:16px;background:url('barterrain_planet_images/planet_images.png') 0px -17px;}
img.planet_planets{width:14px;height:14px;background:url('barterrain_planet_images/other_images.png') -71px -63px;}
img.admins_members_lists{vertical-align:top;width:14px;height:14px;background:url('barterrain_planet_images/other_images.png') -18px -95px;border:none;}
img.planet_memory_box{width:15px;height:15px;background:url('barterrain_planet_images/planet_images.png') -52px -1px;}
img.planet_member_posts{width:13px;height:13px;background:url('barterrain_planet_images/planet_images.png') -67px -17px;}
img.planet_edit{width:15px;height:15px;background:url('barterrain_planet_images/planet_images.png') -50px -17px;}
...
<?php // Planet Block ?>
div.block_background{background-color:<?php echo $color1; ?>;background-image:url('barterrain_planet_images/lines.png');}

<?php // Interactive Box ?>
a.create_choice_pages{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_planet_images/post_field2.png') 0px -53px;}
a.create_choice_pages:hover{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_planet_images/post_field2.png') 0px -136px;}
a.create_choice_groups{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_planet_images/post_field2.png') -119px -53px;}
a.create_choice_groups:hover{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_planet_images/post_field2.png') -119px -136px;}
a.create_choice_events{display:inline-block;margin-right:-4px;margin-right:-3px;width:119px;height:100px;background:url('barterrain_planet_images/post_field2.png') -238px -53px;}
a.create_choice_events:hover{display:inline-block;margin-right:-4px;margin-right:-3px;width:119px;height:100px;background:url('barterrain_planet_images/post_field2.png') -238px -136px;}
a.create_choice_shops{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_planet_images/post_field2.png') -357px -53px;}
a.create_choice_shops:hover{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_planet_images/post_field2.png') -357px -136px;}
...
div.bottom_box_input1{float:left;height:22px;width:366px;background-color:<?php echo $color2; ?>;display:block;padding-top:3px;}
...
div.upload_files4{z-index:5;width:100%;height:24px;overflow:hidden;position:relative;display:block;background:url('../barterrain_main_images/input_file.png') 0px -72px;background-color:#FFFFFF;}
...
<?php // Right Top ?>
#right_inside_menu{z-index:-6;text-align:center;display:none;margin:0px;border:solid 1px #000000;padding:5px;width:215px;background:#FFFFFF;margin-top:-1px;}
#right_inside2_menu{z-index:-6;text-align:center;display:none;margin:0px;border:solid 1px #000000;padding:5px;width:215px;background:#FFFFFF;margin-top:-1px;}
a.right_inside_button:link{vertical-align:top;display:inline-block;width:31px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') -196px 0px;}
a.right_inside_button:visited{vertical-align:top;display:inline-block;width:31px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') -196px 0px;}
a.right_inside_button:hover{vertical-align:top;display:inline-block;width:31px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') -196px -27px;}
a.right_inside_button:active{vertical-align:top;display:inline-block;width:31px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') -196px -27px;}
a.right_inside_button.right_inside_open{vertical-align:top;display:inline-block;width:31px;height:31px;background:url('barterrain_planet_images/right_inside.jpg') -196px -54px;}
a.right_inside2_button{vertical-align:top;display:inline-block;margin-right:2px;width:93px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') -98px 0px;}
a.right_inside2_button:visited{vertical-align:top;display:inline-block;margin-right:2px;width:93px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') -98px 0px;}
a.right_inside2_button:hover{vertical-align:top;display:inline-block;margin-right:2px;width:93px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') -98px -27px;}
a.right_inside2_button:active{vertical-align:top;display:inline-block;margin-right:2px;width:93px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') -98px -27px;}
a.right_inside2_button.right_inside2_open{vertical-align:top;display:inline-block;margin-right:2px;width:93px;height:31px;background:url('barterrain_planet_images/right_inside.jpg') -98px -54px;}
...
div.right_inside2_open a:link{z-index:-6;display:block;font-size:12px;padding:3px;background:#FFFFFF;color:#000000;text-decoration:none;}
div.right_inside2_open a:visited{z-index:-6;display:block;font-size:12px;padding:3px;background:#FFFFFF;color:#000000;text-decoration:none;}
div.right_inside2_open a:hover{z-index:-6;display:block;font-size:12px;padding:3px;background:#DDDDDD;color:#000000;text-decoration:none;}
div.right_inside2_open a:active{z-index:-6;display:block;font-size:12px;padding:3px;background:#DDDDDD;color:#000000;text-decoration:none;}
img.right_inside1{vertical-align:top;float:left;margin-right:5px;width:93px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') 0px 0px;}
img.right_inside3{vertical-align:top;float:left;margin-right:5px;width:93px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') 0px -27px;}
img.right_inside4{vertical-align:top;float:left;margin-right:5px;width:93px;height:25px;background:url('barterrain_planet_images/right_inside.jpg') 0px -54px;}
img.right_outside1{vertical-align:top;float:left;margin-right:5px;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') 0px 0px;}
img.right_outside1:hover{vertical-align:top;float:left;margin-right:5px;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') 0px -27px;}
img.right_outside1:active{vertical-align:top;float:left;margin-right:5px;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') 0px -27px;}
img.right_outside2{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') -116px 0px;}
img.right_outside2:hover{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') -232px -27px;}
img.right_outside2:active{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') -232px -27px;}
img.right_outside2{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') -116px 0px;}
img.right_outside2:hover{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') -232px -27px;}
img.right_outside2:active{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') -232px -27px;}
img.right_outside3{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') -232px 0px;}
img.right_outside3:hover{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') -116px -27px;}
img.right_outside3:active{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_planet_images/right_outside.jpg') -116px -27px;}
...
img.points_lists{vertical-align:top;margin-right:6px;width:12px;height:13px;background:url('barterrain_planet_images/other_images.png') -70px -18px;border:none;}
img.mutual_friends_bar{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_planet_images/other_images.png') -32px -32px;border:none;}
img.requests_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_planet_images/other_images.png') -0px -48px;border:none;}
img.general_info_bar{vertical-align:top;margin-right:6px;width:15px;height:13px;background:url('barterrain_planet_images/planet_images.png') -17px -2px;border:none;}
img.pages_lists{vertical-align:top;margin-right:6px;width:15px;height:14px;background:url('barterrain_planet_images/other_images.png')  0px -18px;border:none;}
img.groups_lists{vertical-align:top;margin-right:6px;width:15px;height:14px;background:url('barterrain_planet_images/other_images.png') -17px -18px;border:none;}
img.events_lists{vertical-align:top;margin-right:6px;width:15px;height:14px;background:url('barterrain_planet_images/other_images.png') -69px -1px;border:none;}
img.shops_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_planet_images/other_images.png') -52px -18px;border:none;}
img.albums_lists{vertical-align:top;margin-right:6px;width:16px;height:14px;background:url('barterrain_planet_images/other_images.png') -34px -1px;border:none;}
img.videos_lists{vertical-align:top;margin-right:6px;width:15px;height:13px;background:url('barterrain_planet_images/other_images.png') -16px -33px;border:none;}
img.games_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_planet_images/other_images.png') -1px -33px;border:none;}
img.subscribers_lists{vertical-align:top;margin-right:6px;width:18px;height:13px;background:url('barterrain_planet_images/other_images.png') -47px -33px;border:none;}
img.subscriptions_lists{vertical-align:top;margin-right:6px;width:18px;height:13px;background:url('barterrain_planet_images/other_images.png') -66px -33px;border:none;}
img.subscriptions_activity_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_planet_images/other_images.png') -35px -18px;border:none;}
img.information_bar{vertical-align:top;margin-right:6px;width:10px;height:14px;background:url('barterrain_planet_images/other_images.png') -58px -64px;border:none;}
img.planets_linked_lists{vertical-align:top;margin-right:6px;width:24px;height:14px;background:url('barterrain_planet_images/other_images.png') -34px -96px;border:none;}
img.planets_lists{vertical-align:top;margin-right:6px;width:13px;height:14px;background:url('barterrain_planet_images/other_images.png') -71px -64px;border:none;}
img.planets_colonized_lists{vertical-align:top;margin-right:6px;width:13px;height:14px;background:url('barterrain_planet_images/other_images.png') -57px -64px;border:none;}
img.planet_info_bar{vertical-align:top;margin-right:6px;width:22px;height:14px;background:url('barterrain_planet_images/other_images.png') -41px -80px;border:none;}
img.profile_info_bar{vertical-align:top;margin-right:6px;width:19px;height:14px;background:url('barterrain_planet_images/other_images.png') -19px -80px;border:none;}
img.members_lists{vertical-align:top;margin-right:6px;width:17px;height:14px;background:url('barterrain_planet_images/other_images.png') -65px -80px;border:none;}
img.admins_lists{vertical-align:top;margin-right:6px;width:17px;height:14px;background:url('barterrain_planet_images/other_images.png') -0px -95px;border:none;}
img.friends_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_planet_images/planet_images.png') -18px -18px;border:none;}
img.family_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_planet_images/other_images.png') -52px -1px;border:none;}
...
div.create_box2{vertical-align:bottom;text-align:left;width:335px;color:#000000;padding-bottom:2px;overflow:hidden;}
div.create_box3{position:relative;vertical-align:top;float:right;text-align:left;width:417px;color:#696969;}
...
<?php // Uploads ?>
a.album_tab1{float:left;width:72px;height:25px;background:url('barterrain_planet_images/post_field2.jpg') 0px -0px;}
a.album_tab1.selected_box{float:left;width:72px;height:25px;background:url('barterrain_planet_images/post_field2.jpg') 0px -27px;}
a.album_tab2{float:left;width:72px;height:25px;background:url('barterrain_planet_images/post_field2.jpg') -72px -0px;}
a.album_tab2.selected_box{float:left;width:72px;height:25px;background:url('barterrain_planet_images/post_field2.jpg') -72px -27px;}
a.album_tab3{float:left;width:100px;height:25px;background:url('barterrain_planet_images/post_field2.jpg') -145px -0px;}
a.album_tab3.selected_box{float:left;width:100px;height:25px;background:url('barterrain_planet_images/post_field2.jpg') -145px -27px;}
...
div.bottom_middle_planet{text-align:left;width:100%;}
...
div.game_box22{vertical-align:top;float:right;text-align:left;width:279px;color:#000000;overflow:hidden;}
div.game_box3{position:relative;vertical-align:top;float:right;text-align:left;width:417px;color:#696969;background-color:#FFFFFF}
