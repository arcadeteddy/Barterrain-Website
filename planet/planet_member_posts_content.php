...
////////// MEMBER POSTS!!! //////////
$mysql1 = mysql_query("SELECT * FROM planets_member_posts WHERE user_page_id='$id' AND delete_item='1' ORDER BY post_date DESC LIMIT ".$number.",20");
...
$(window).data('ajaxready2', true).scroll(function(e)
	...
	if($(window).scrollTop()>=$(document).height()-$(window).height())
		...
		$.ajax({cache: false,url:"planet_member_posts_content.php?number="+number+"&cacheBuster="+cacheBuster+"&id="+id+"&ids="+ids,
			success:function(html)
				{if(html){$("#bottom_member_post").append(html);$("div#load_content_scroll").hide();$("div#expand_bottom_box").show();}
