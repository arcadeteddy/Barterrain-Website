...
unset($albums_array);
$mysql = mysql_query("SELECT id FROM planets_albums WHERE user_page_id=$id $view_type AND member_album_active='b' AND delete_item='1' ORDER BY upload_date DESC");
...
if ($numRows>0)
	...
	$albumsDisplayList .= "<div class='middle_bars'>
						<div class='float_left'><img src='blank.gif' width='1px' height='1px' class='albums_lists'/><span class='heading_list'>Member Albums (".$numRows.")</span></div>
