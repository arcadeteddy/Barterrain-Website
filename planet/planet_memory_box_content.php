...
////////// MEMORY BOX!!! //////////
$mysql_union = mysql_query("(SELECT id, post_date AS datetime, union_type FROM planets_posts WHERE user_page_id='$id' AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_member_posts WHERE user_page_id='$id' AND user_post_id='$ids' AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, note_date AS datetime, union_type FROM planets_notes WHERE user_page_id='$id' AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, upload_date AS datetime, union_type FROM planets_albums WHERE user_page_id='$id' AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, upload_date AS datetime, union_type FROM planets_images_walls WHERE user_page_id='$id' AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, upload_date AS datetime, union_type FROM planets_videos WHERE user_page_id='$id' AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, upload_date AS datetime, union_type FROM planets_games WHERE user_page_id='$id' AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_albums_posts WHERE  (user_post_id='$user_id' OR (user_page_id='$id' AND user_post_id='$ids')) AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_images_posts WHERE  (user_post_id='$user_id' OR (user_page_id='$id' AND user_post_id='$ids')) AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_games_posts WHERE  (user_post_id='$user_id' OR (user_page_id='$id' AND user_post_id='$ids')) AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_videos_posts WHERE  (user_post_id='$user_id' OR (user_page_id='$id' AND user_post_id='$ids')) AND delete_item='1' AND memory_type='b')
					UNION ALL(SELECT id, link_create_date AS datetime, union_type FROM link_creates WHERE (user_page_id='$id' OR planet_id='$id') AND delete_item='1' AND memory_type='b') 
...
{$mysql1 = mysql_query("SELECT * FROM planets_images_posts WHERE id='$item_id' AND post_date='$datetime' LIMIT 1");
while ($row = mysql_fetch_array ($mysql1))
...
$(window).data('ajaxready7', true).scroll(function()
	{if ($(window).data('ajaxready7') == false) return;
	if($(window).scrollTop()>=$("#bottom_memory_box").height()-$(document).height())
		{$("div#expand_bottom_box").hide();
		$("div#load_content_scroll").show();
		$(window).data('ajaxready7', false);
		$.ajax({cache: false,url:"planet_memory_box_content.php?number="+number+"&cacheBuster="+cacheBuster+"&id="+id+"&ids="+ids,
			success:function(html)
				{if(html){$("#bottom_memory_box").append(html);$("div#load_content_scroll").hide();$("div#expand_bottom_box").show();}
				 $(window).data('ajaxready7', true);}
			});
		}
	});
