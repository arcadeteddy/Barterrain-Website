...
$AlbumArray ="0";
$mysql_albums = mysql_query("SELECT id FROM planets_albums WHERE user_page_id='$id' AND union_type='albums'");
while($row = mysql_fetch_array($mysql_albums))
	{$album_id = $row['id'];
	$AlbumArray = $AlbumArray.",".$album_id;}
$AlbumArray = explode(",",$AlbumArray);
$AlbumArray = join(',',$AlbumArray);

$VideoArray ="0";
$mysql_videos = mysql_query("SELECT id FROM planets_videos WHERE user_page_id='$id' AND union_type='videos'");
while($row = mysql_fetch_array($mysql_videos))
	{$video_id = $row['id'];
	$VideoArray = $VideoArray.",".$video_id;}
$VideoArray = explode(",",$VideoArray);
$VideoArray = join(',',$VideoArray);

$GameArray ="0";
$mysql_games = mysql_query("SELECT id FROM planets_games WHERE user_page_id='$id' AND union_type='games'");
while($row = mysql_fetch_array($mysql_games))
	{$game_id = $row['id'];
	$GameArray = $GameArray.",".$game_id;}
$GameArray = explode(",",$GameArray);
$GameArray = join(',',$GameArray);
	
////////// WALL!!! //////////
$mysql_union = mysql_query("(SELECT id, note_date AS datetime, union_type FROM planets_notes WHERE user_page_id='$id' AND delete_item='1')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_posts WHERE user_page_id='$id' AND delete_item='1')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_member_posts WHERE user_page_id='$id' AND user_post_id='$ids' AND delete_item='1')
					UNION ALL(SELECT id, upload_date AS datetime, union_type FROM planets_albums WHERE user_page_id='$id' AND delete_item='1')
					UNION ALL(SELECT id, upload_date AS datetime, union_type FROM planets_images_walls WHERE user_page_id='$id' AND delete_item='1')
					UNION ALL(SELECT id, upload_date AS datetime, union_type FROM planets_videos WHERE user_page_id='$id' AND delete_item='1')
					UNION ALL(SELECT id, upload_date AS datetime, union_type FROM planets_games WHERE user_page_id='$id' AND delete_item='1')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_albums_posts WHERE ((user_page_id='$id' AND user_post_id='$user_id') OR (user_page_id='$id' AND user_post_id='$ids')) AND delete_item='1')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_videos_posts WHERE ((user_page_id='$id' AND user_post_id='$user_id') OR (user_page_id='$id' AND user_post_id='$ids')) AND delete_item='1')
					UNION ALL(SELECT id, post_date AS datetime, union_type FROM planets_games_posts WHERE ((user_page_id='$id' AND user_post_id='$user_id') OR (user_page_id='$id' AND user_post_id='$ids')) AND delete_item='1')
					UNION ALL(SELECT id, link_create_date AS datetime, union_type FROM link_creates WHERE (user_page_id='$id' OR planet_id='$id') AND delete_item='1') 
...
while ($row = mysql_fetch_array ($mysql1))
	...
	$row2=mysql_fetch_assoc($mysql2);
		...
		if ($creator_display=="1")
			...
			{$check_pic="../planet_files/planet$id/planet_thumb.jpg";
			$default_pic="../planet_files/planet0/planet_thumb.png";
			if (file_exists($check_pic))
				{$user_pic="<a href='../planet/planet.php?id=".$id."'><img src='$check_pic#$cacheBuster' width='55px' height='55px' class='thumb_background'/></a>";}
			else
				{$user_pic="<a href='../planet/planet.php?id=".$id."'><img src='$default_pic' width='55px' height='55px' class='thumb_background' /></a>";}}
		}
	...
	else{$point="<div title='Point Array' class='option_box2'><a href='#' class='point0 display_button' onclick='return false' onmousedown='javascript:display_point_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'></a><a href='#' onclick='return false' class='body display_button' onmousedown='javascript:display_point_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'><b class='point3'>".$point_array_count_note."</b></a></div>";}
	$comment_space="";
	if ($comment_count>0)
...
while ($row = mysql_fetch_array ($mysql1))
	...
	if (in_array($ids,$likeArray_post))
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unlikeLike_item(".$id.",".$ids.", ".$post_id.",".$comment_type.");'>Unlike</a>";}
	else if (in_array($ids,$loveArray_post))
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unloveLove_item(".$id.",".$ids.", ".$post_id.",".$comment_type.");'>Unlove</a>";}
	else 
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:Like_item(".$id.",".$ids.", ".$post_id.",".$comment_type.");'>Like</a><span class='dot_divider'> &middot; </span>
						<a href='#' class='post_link' onclick='return false' onmousedown='javascript:Love_item(".$id.",".$ids.", ".$post_id.",".$comment_type.");'>Love</a>";}
...
while ($row = mysql_fetch_array ($mysql1))
	...
	if (in_array($ids,$likeArray_post))
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unlikeLike_item(".$id.",".$ids.", ".$member_post_id.",".$comment_type.");'>Unlike</a>";}
	else if (in_array($ids,$loveArray_post))
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unloveLove_item(".$id.",".$ids.", ".$member_post_id.",".$comment_type.");'>Unlove</a>";}
	else 
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:Like_item(".$id.",".$ids.", ".$member_post_id.",".$comment_type.");'>Like</a><span class='dot_divider'> &middot; </span>
						<a href='#' class='post_link' onclick='return false' onmousedown='javascript:Love_item(".$id.",".$ids.", ".$member_post_id.",".$comment_type.");'>Love</a>";}
	if (($like_array_post !="")AND($love_array_post !=""))
		{$like_love2_post = "<span class='dot_divider'> &middot; </span><a href='#' title='Like Array' class='post_link display_button' onclick='return false' onmousedown='javascript:display_like_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'>".$like_array_count_post."</a> <img src='blank.gif' width='1px' height='1px' class='like_count'/><span class='dot_divider'> &middot; </span>
						<a href='#' title='Love Array' class='post_link display_button' onclick='return false' onmousedown='javascript:display_love_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'>".$love_array_count_post."</a> <img src='blank.gif' width='1px' height='1px' class='love_count'/>";}
	else if ($like_array_post !="")
...
while ($row = mysql_fetch_array ($mysql1))
	...
	$album_pic="../planet_files/planet$id/planet_album_thumbs_$album_id/planet_album_".$album_id."_cover2.jpg";
	$album_default_pic="../planet_files/planet0/default_album_cover_thumb.png";
	if (file_exists($album_pic))
		{$album_cover="<a href='#' onclick='return false' onmousedown='javascript:album_opener(".$ids.",".$id.",".$album_id.");'><img class='cover thumb_background' src='$album_pic#$cacheBuster' height='76px' width='130px'/></a>";}
	else {$album_cover="<a href='#' onclick='return false' onmousedown='javascript:album_opener(".$ids.",".$id.",".$album_id.");'><img class='cover thumb_background' src='$album_default_pic' height='76px' width='130px'/></a>";}
	...
	$DisplayList .= "<div id='item_box_albums".$album_id."'>
			...
			<div class='album_box22'><b>New Album: </b><a href='#' onclick='return false' onmousedown='javascript:album_opener(".$ids.",".$id.",".$album_id.");' class='body'>".$album_name."</a></div>
...
while ($row = mysql_fetch_array ($mysql1))
	...
	else{$point="<div title='Point Array' class='option_box2'><a href='#' class='point0 display_button' onclick='return false' onmousedown='javascript:display_point_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'></a><a href='#' onclick='return false' class='body display_button' onmousedown='javascript:display_point_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'><b class='point3'>".$point_array_count_images_walls."</b></a></div>";}
	$comment_space="";
	if ($comment_count>0)
	...
	if($images_count==1)
		{foreach ($imagesArray as $key => $value)
			...
			$row=mysql_fetch_assoc($mysql_gif);
				{$ext=$row['ext'];}
			if ($ext=="gif") {$black_gif="<div style='float:left;'><img class='black_gif' src='barterrain_planet_images/black.png' height='415px' width='415px'/></div><table class='black_gif' height='415px' width='415px'><tr><td><span class='black_gif'>GIF</span></td></tr></table>";}
		...
		{foreach ($imagesArray as $key => $value)
			...
			$row=mysql_fetch_assoc($mysql_gif);
				{$ext=$row['ext'];}
			if ($ext=="gif") {$black_gif="<div style='float:left;'><img class='black_gif' src='barterrain_planet_images/black.png' height='203px' width='203px'/></div><table class='black_gif' height='203px' width='203px'><tr><td><span class='black_gif'>GIF</span></td></tr></table>";}
			$i++;$images_pic="../planet_files/planet$user_page_id/planet_album_thumbs_$album_id/planet_album_".$album_id."_thumb_".$value.".jpg";
		...
		{foreach ($imagesArray as $key => $value)
			...
			$row=mysql_fetch_assoc($mysql_gif);
				{$ext=$row['ext'];}
			if ($ext=="gif") {$black_gif="<div style='float:left;'><img class='black_gif' src='barterrain_planet_images/black.png' height='133px' width='133px'/></div><table class='black_gif' height='133px' width='133px'><tr><td><span class='black_gif'>GIF</span></td></tr></table>";}
			$i++;$images_pic="../planet_files/planet$user_page_id/planet_album_thumbs_$album_id/planet_album_".$album_id."_thumb_".$value.".jpg";
	...
	$DisplayList .= "<div id='item_box_images_walls".$images_wall_id."'>
			...
			<b>New Images: </b><a class='body' href='#' onclick='return false' onmousedown='javascript:album_opener(".$ids.",".$id.",".$album_id.");'>".$album_name."</a>!</div></div>	
...
while ($row = mysql_fetch_array ($mysql1))
	...
	$DisplayList .= "<div id='item_box_videos".$video_id."'>
			...
			<div class='video_box22'><b>New Video: </b><a class='body' href='#' onclick='return false' onmousedown='javascript:video_opener(".$ids.",".$id.",".$video_id.");'>".$video_name."</a></div>
...
while ($row = mysql_fetch_array ($mysql1))
	...
	if (file_exists($game_pic))
		{$game_cover="<a href='#' onclick='return false' onmousedown='javascript:game_opener(".$ids.",".$id.",".$game_id.");'><img class='cover thumb_background' src='$game_pic#$cacheBuster' height='76px' width='130px'/></a>";}
	else {$game_cover="<a href='#' onclick='return false' onmousedown='javascript:game_opener(".$ids.",".$id.",".$game_id.");'><img class='cover thumb_background' src='$game_default_pic' height='76px' width='130px'/></a>";}
	...
	$DisplayList .= "<div id='item_box_games".$game_id."'>
			...
			<div class='game_box22'><b>New Game: </b><a class='body' href='#' onclick='return false' onmousedown='javascript:game_opener(".$ids.",".$id.",".$game_id.");'>".$game_name."</a></div>
...
while ($row = mysql_fetch_array ($mysql1))
	...
	if (in_array($ids,$likeArray_post))
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unlikeLike_item(".$id.",".$ids.", ".$albums_post_id.",".$comment_type.");'>Unlike</a>";}
	else if (in_array($ids,$loveArray_post))
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unloveLove_item(".$id.",".$ids.", ".$albums_post_id.",".$comment_type.");'>Unlove</a>";}
	else 
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:Like_item(".$id.",".$ids.", ".$albums_post_id.",".$comment_type.");'>Like</a><span class='dot_divider'> &middot; </span>
	...
	$DisplayList .= "<div id='item_box_albums_posts".$albums_post_id."'>
			...
			<div class='post_box2'>".$profile_link."<font style='color:black;'> &#9658; <font style='color:black;font-size:14px;'>Album: </font></font>
				<a class='profile_link' href='#' onclick='return false' onmousedown='javascript:album_opener(".$ids.",".$id.",".$album_id.");'>".$album_name."</a></div>
			<div class='post_box2'>".$the_post."</div>
...
while ($row = mysql_fetch_array ($mysql1))
	...
	if (in_array($ids,$likeArray_post))
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unlikeLike_item(".$id.",".$ids.", ".$videos_post_id.",".$comment_type.");'>Unlike</a>";}
	else if (in_array($ids,$loveArray_post))
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unloveLove_item(".$id.",".$ids.", ".$videos_post_id.",".$comment_type.");'>Unlove</a>";}
	else 
		{$like_love_post = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:Like_item(".$id.",".$ids.", ".$videos_post_id.",".$comment_type.");'>Like</a><span class='dot_divider'> &middot; </span>
	...
	$DisplayList .= "<div id='item_box_videos_posts".$videos_post_id."'>
			...
			<div class='post_box2'>".$profile_link."<font style='color:black;'> &#9658; <font style='color:black;font-size:14px;'>Video: </font></font>
				<a class='profile_link' href='#' onclick='return false' onmousedown='javascript:video_opener(".$ids.",".$id.",".$video_id.");'>".$video_name."</a></div>
			<div class='post_box2'>".$the_post."</div>
...
while ($row = mysql_fetch_array ($mysql1))
	...
	$DisplayList .= "<div id='item_box_games_posts".$games_post_id."'>
			...
			<div class='post_box2'>".$profile_link."<font style='color:black;'> &#9658; <font style='color:black;font-size:14px;'>Game: </font></font>
				<a class='profile_link' href='#' onclick='return false' onmousedown='javascript:game_opener(".$ids.",".$id.",".$game_id.");'>".$game_name."</a></div>
			<div class='post_box2'>".$the_post."</div>
...
while ($row = mysql_fetch_array ($mysql1))
	...
	if (in_array($ids,$likeArray_link_create))
		{$like_love_link_create = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unlikeLike_item(".$id.",".$ids.", ".$link_create_id.",".$comment_type.");'>Unlike</a>";}
	else if (in_array($ids,$loveArray_link_create))
		{$like_love_link_create = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:unloveLove_item(".$id.",".$ids.", ".$link_create_id.",".$comment_type.");'>Unlove</a>";}
	else 
		{$like_love_link_create = "<a href='#' class='post_link' onclick='return false' onmousedown='javascript:Like_item(".$id.",".$ids.", ".$link_create_id.",".$comment_type.");'>Like</a><span class='dot_divider'> &middot; </span>
						<a href='#' class='post_link' onclick='return false' onmousedown='javascript:Love_item(".$id.",".$ids.", ".$link_create_id.",".$comment_type.");'>Love</a>";}
	if (($like_array_link_create !="")AND($love_array_link_create !=""))
		{$like_love2_link_create = "<span class='dot_divider'> &middot; </span><a href='#' title='Like Array' class='post_link display_button' onclick='return false' onmousedown='javascript:display_like_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'>".$like_array_count_link_create."</a> <img src='blank.gif' width='1px' height='1px' class='like_count'/><span class='dot_divider'> &middot; </span>
						<a href='#' title='Love Array' class='post_link display_button' onclick='return false' onmousedown='javascript:display_love_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'>".$love_array_count_link_create."</a> <img src='blank.gif' width='1px' height='1px' class='love_count'/>";}
	else if ($like_array_link_create !="")
		{$like_love2_link_create = "<span class='dot_divider'> &middot; </span><a href='#' title='Like Array' class='post_link display_button' onclick='return false' onmousedown='javascript:display_like_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'>".$like_array_count_link_create."</a> <img src='blank.gif' width='1px' height='1px' class='like_count'/>";}
	else if ($love_array_link_create !="")
		{$like_love2_link_create = "<span class='dot_divider'> &middot; </span><a href='#' title='Love Array' class='post_link display_button' onclick='return false' onmousedown='javascript:display_love_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'>".$love_array_count_link_create."</a> <img src='blank.gif' width='1px' height='1px' class='love_count'/>";}
	else
		{$like_love2_link_create = "";}
	...
	else{$point="<div title='Point Array' class='option_box2'><a href='#' class='point0 display_button' onclick='return false' onmousedown='javascript:display_point_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'></a><a href='#' onclick='return false' class='body display_button' onmousedown='javascript:display_point_array(".$id.",".$ids.",".$item_id.",".$comment_type.");'><b class='point3'>".$point_array_count_link_create."</b></a></div>";}
	$comment_space="";
	if ($comment_count>0)
		{$comment_space = 'class="comment_space"';}
	...
	if ($creator_display=="0")
		{$profile_link="<a class='profile_link' href='../planet/planet.php?id=".$planet_link_create_id."'>".$planet_name."</a>";}
	else if ($creator_display=="1")
		{if ($alias_activation=="1") 
			{$profile_link="<a class='alias_link' href='#' onclick='return false'>".$alias."</a>";}
		else if ($alias_activation=="0") 
	...
	else{$comment_point="<div title='Point Array' class='option_box2'><a href='#' class='point display_button' onclick='return false'  onmousedown='javascript:display_point_array_comment(".$id.",".$ids.",".$comment_id.",".$comment_type.");'></a><a href='#' title='Point Array' class='body display_button' onclick='return false' onmousedown='javascript:display_point_array_comment(".$id.",".$ids.",".$comment_id.",".$comment_type.");'><b class='point3'>".$comment_point_array_count_link_create."</b></a></div>";}
...
$(window).data('ajaxready1', true).scroll(function()
	...
	if($(window).scrollTop()>=$("#bottom_wall").height()-$(document).height())
		{$("div#expand_bottom_box").hide();
		$("div#load_content_scroll").show();
		$(window).data('ajaxready1', false);
		$.ajax({cache: false,url:"planet_wall_content.php?number="+number+"&cacheBuster="+cacheBuster+"&id="+id+"&ids="+ids,
			success:function(html)
				{if(html){$("#bottom_wall").append(html);$("div#load_content_scroll").hide();$("div#expand_bottom_box").show();}
...
window.onload=function()
		{$('#planet_page_middle').css('min-height', $('#planet_page_left').height()+'px');};
</script>
