...
////////// NOTES!!! //////////
$mysql1 = mysql_query("SELECT * FROM planets_notes WHERE user_page_id='$id' AND delete_item='1' ORDER BY note_date DESC LIMIT ".$number.",20");
$numRows = mysql_num_rows($mysql1);
...
$(window).data('ajaxready4', true).scroll(function(e)
	...
	if($(window).scrollTop()>=$(document).height()-$(window).height())
		...
		$.ajax({cache: false,url:"planet_notes_content.php?number="+number+"&cacheBuster="+cacheBuster+"&id="+id+"&ids="+ids,
			success:function(html)
				{if(html){$("#bottom_note").append(html);$("div#load_content_scroll").hide();$("div#expand_bottom_box").show();}
