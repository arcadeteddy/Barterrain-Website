...
div.inside_page_body{float:left;width:1060px;position:absolute;margin:0px 60px;min-height:100%;}
div.inside_page_body_cover{text-align:left;width:1180px;margin:0 auto;overflow:hidden;}
div.inside_page_body_left{position:fixed;width:30px;margin-left:235px;background:url('../barterrain_main_images/side_shadows.png') -0px -0px;background-repeat:repeat-y;height:100%;z-index:-2;}
div.inside_page_body_right{position:fixed;width:30px;margin-left:1120px;background:url('../barterrain_main_images/side_shadows.png') -30px -0px;background-repeat:repeat-y;height:100%;z-index:-2;}
div.inside_page_left{float:left;text-align:center;width:265px;z-index:6;overflow:hidden;}
div.inside_page_right{float:right;text-align:left;height:100%;width:793px;border-left-style:solid;border-right-style:solid;border-color:<?php echo $color2; ?>;border-width:1px;position:relative;z-index:3;}
div.inside_page_middle_left{overflow:hidden;text-align:left;float:left;width:490px;padding:19px;border-right-style:solid;border-color:<?php echo $color2; ?>;border-width:1px;}
div.inside_page_middle_left.expand{overflow:hidden;text-align:left;float:left;width:763px;padding:19px;border-right-style:solid;border-color:<?php echo $color2; ?>;border-width:1px;}
div.inside_page_middle_right{overflow:hidden;text-align:left;right:right;width:264px;}
...
img.inside_image{border-right-style:solid;border-right-width:2px;border-top-style:solid;border-bottom-style:solid;border-left-style:solid;border-width:3px;border-color:<?php echo $color2; ?>;position:relative;z-index:6;}
img.inside_news{outline:0px;width:16px;height:15px;background:url('barterrain_inside_images/inside_images.png') 0px 0px;}
img.inside_media{outline:0px;width:16px;height:15px;background:url('barterrain_inside_images/inside_images.png') -34px 1px;}
img.inside_notes{outline:0px;width:15px;height:15px;background:url('barterrain_inside_images/inside_images.png') -70px -47px;}
img.inside_family{width:16px;height:15px;background:url('barterrain_inside_images/inside_images.png') -51px 1px;}
img.inside_subscriptions{width:16px;height:15px;background:url('barterrain_inside_images/inside_images.png') -34px -16px;}
img.inside_planets{width:14px;height:14px;background:url('barterrain_inside_images/inside_images.png') -71px -63px;}
img.inside_pages{width:16px;height:15px;background:url('barterrain_inside_images/inside_images.png') 0px -17px;}
img.inside_groups{width:16px;height:15px;background:url('barterrain_inside_images/inside_images.png') -16px -17px;}
img.inside_events{width:16px;height:15px;background:url('barterrain_inside_images/inside_images.png') -68px -1px;}
img.inside_shops{width:16px;height:15px;background:url('barterrain_inside_images/home_images.png') -50px -16px;}
...
<?php // Interactive Box ?>
a.create_choice_pages{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_inside_images/post_field2.png') 0px -53px;}
a.create_choice_pages:hover{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_inside_images/post_field2.png') 0px -136px;}
a.create_choice_groups{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_inside_images/post_field2.png') -119px -53px;}
a.create_choice_groups:hover{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_inside_images/post_field2.png') -119px -136px;}
a.create_choice_events{display:inline-block;margin-right:-4px;margin-right:-3px;width:119px;height:100px;background:url('barterrain_inside_images/post_field2.png') -238px -53px;}
a.create_choice_events:hover{display:inline-block;margin-right:-4px;margin-right:-3px;width:119px;height:100px;background:url('barterrain_inside_images/post_field2.png') -238px -136px;}
a.create_choice_shops{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_inside_images/post_field2.png') -357px -53px;}
a.create_choice_shops:hover{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('barterrain_inside_images/post_field2.png') -357px -136px;}
...
a.top_box6{float:right;width:98px;height:25px;background:url('../barterrain_main_images/post_field.png') -400px -54px;margin:0px;padding:0px;background-color:<?php echo $color4; ?>;}
a.top_box6.selected_box{float:right;width:98px;height:25px;background:url('../barterrain_main_images/post_field.png') -400px -54px;margin:0px;padding:0px;background-color:<?php echo $color2; ?>;}
...
a.right_inside_button:link{vertical-align:top;display:inline-block;width:31px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -196px 0px;}
a.right_inside_button:visited{vertical-align:top;display:inline-block;width:31px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -196px 0px;}
a.right_inside_button:hover{vertical-align:top;display:inline-block;width:31px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -196px -27px;}
a.right_inside_button:active{vertical-align:top;display:inline-block;width:31px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -196px -27px;}
a.right_inside_button.right_inside_open{vertical-align:top;display:inline-block;width:31px;height:31px;background:url('barterrain_inside_images/right_inside.jpg') -196px -54px;}
...
img.right_inside1{vertical-align:top;float:left;margin-right:5px;width:93px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') 0px 0px;}
img.right_inside2{vertical-align:top;float:left;width:93px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -98px 0px;}
img.right_inside2:visited{vertical-align:top;float:left;width:93px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -98px 0px;}
img.right_inside2:hover{vertical-align:top;float:left;width:93px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -98px -27px;}
img.right_inside2:active{vertical-align:top;float:left;width:93px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -98px -27px;}
img.right_inside3{vertical-align:top;float:left;margin-right:5px;width:93px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') 0px -27px;}
img.right_inside4{vertical-align:top;float:left;margin-right:5px;width:93px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') 0px -54px;}
img.right_inside5{vertical-align:top;float:left;margin-right:5px;width:93px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -85px -54px;}
img.right_inside6{vertical-align:top;float:left;margin-right:5px;width:93px;height:25px;background:url('barterrain_inside_images/right_inside.jpg') -98px -54px;}
img.right_outside1{vertical-align:top;float:left;margin-right:5px;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') 0px 0px;}
img.right_outside1:hover{vertical-align:top;float:left;margin-right:5px;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') 0px -27px;}
img.right_outside1:active{vertical-align:top;float:left;margin-right:5px;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') 0px -27px;}
img.right_outside2{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') -116px 0px;}
img.right_outside2:hover{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') -232px -27px;}
img.right_outside2:active{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') -232px -27px;}
img.right_outside2{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') -116px 0px;}
img.right_outside2:hover{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') -232px -27px;}
img.right_outside2:active{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') -232px -27px;}
img.right_outside3{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') -232px 0px;}
img.right_outside3:hover{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') -116px -27px;}
img.right_outside3:active{vertical-align:top;float:left;width:111px;height:25px;background:url('barterrain_inside_images/right_outside.jpg') -116px -27px;}
...
img.points_lists{vertical-align:top;margin-right:6px;width:12px;height:13px;background:url('barterrain_inside_images/inside_images.png') -70px -18px;border:none;}
img.mutual_friends_bar{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_inside_images/inside_images.png') -32px -32px;border:none;}
img.requests_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_inside_images/inside_images.png') -0px -48px;border:none;}
img.friends_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_inside_images/inside_images.png') -16px -48px;border:none;}
img.family_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_inside_images/inside_images.png') -52px -1px;border:none;}
img.general_info_bar{vertical-align:top;margin-right:6px;width:15px;height:13px;background:url('barterrain_inside_images/inside_images.png') -17px -2px;border:none;}
img.pages_lists{vertical-align:top;margin-right:6px;width:15px;height:14px;background:url('barterrain_inside_images/inside_images.png')  0px -18px;border:none;}
img.groups_lists{vertical-align:top;margin-right:6px;width:15px;height:14px;background:url('barterrain_inside_images/inside_images.png') -17px -18px;border:none;}
img.events_lists{vertical-align:top;margin-right:6px;width:15px;height:14px;background:url('barterrain_inside_images/inside_images.png') -69px -1px;border:none;}
img.shops_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_inside_images/inside_images.png') -52px -18px;border:none;}
img.albums_lists{vertical-align:top;margin-right:6px;width:16px;height:14px;background:url('barterrain_inside_images/inside_images.png') -34px -1px;border:none;}
img.videos_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_inside_images/inside_images.png') -18px -33px;border:none;}
img.games_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_inside_images/inside_images.png') -1px -33px;border:none;}
img.subscribers_lists{vertical-align:top;margin-right:6px;width:18px;height:13px;background:url('barterrain_inside_images/inside_images.png') -47px -33px;border:none;}
img.subscriptions_lists{vertical-align:top;margin-right:6px;width:18px;height:13px;background:url('barterrain_inside_images/inside_images.png') -66px -33px;border:none;}
img.subscriptions_activity_lists{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_inside_images/inside_images.png') -35px -18px;border:none;}
img.create_pages_bar{vertical-align:top;margin-right:6px;width:19px;height:14px;background:url('barterrain_inside_images/inside_images.png') -50px -48px;border:none;}
img.create_groups_bar{vertical-align:top;margin-right:6px;width:19px;height:14px;background:url('barterrain_inside_images/inside_images.png') -0px -64px;border:none;}
img.create_events_bar{vertical-align:top;margin-right:6px;width:19px;height:14px;background:url('barterrain_inside_images/inside_images.png') -30px -48px;border:none;}
img.create_shops_bar{vertical-align:top;margin-right:6px;width:17px;height:14px;background:url('barterrain_inside_images/inside_images.png') -21px -64px;border:none;}
img.information_bar{vertical-align:top;margin-right:6px;width:10px;height:14px;background:url('barterrain_inside_images/inside_images.png') -58px -64px;border:none;}
img.planets_lists{vertical-align:top;margin-right:6px;width:13px;height:14px;background:url('barterrain_inside_images/inside_images.png') -71px -64px;border:none;}
img.planets_colonized_lists{vertical-align:top;margin-right:6px;width:13px;height:14px;background:url('barterrain_inside_images/inside_images.png') -57px -64px;border:none;}
img.mutual_friends_planet{vertical-align:top;margin-right:6px;width:17px;height:14px;background:url('barterrain_inside_images/inside_images.png') -0px -80px;border:none;}
img.daily_points{vertical-align:top;margin-right:6px;width:13px;height:13px;background:url('barterrain_inside_images/inside_images.png') -52px -18px;border:none;}
...
a.points_choice_advertise{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('../barterrain_main_images/post_field.png') 0px -248px;}
a.points_choice_advertise:hover{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('../barterrain_main_images/post_field.png') 0px -331px;}
a.points_choice_bc{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('../barterrain_main_images/post_field.png') -119px -248px;}
a.points_choice_bc:hover{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('../barterrain_main_images/post_field.png') -119px -331px;}
a.points_choice_reveal{display:inline-block;margin-right:-4px;margin-right:-3px;width:119px;height:100px;background:url('../barterrain_main_images/post_field.png') -238px -248px;}
a.points_choice_reveal:hover{display:inline-block;margin-right:-4px;margin-right:-3px;width:119px;height:100px;background:url('../barterrain_main_images/post_field.png') -238px -331px;}
a.points_choice_tt{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('../barterrain_main_images/post_field.png') -357px -248px;}
a.points_choice_tt:hover{display:inline-block;margin-right:-4px;width:119px;height:100px;background:url('../barterrain_main_images/post_field.png') -357px -331px;}
...
div.bottom_middle_inside{text-align:left;width:100%;}
...
div.image_box_wrap{position:relative;vertical-align:top;float:left;width:1000px;overflow:hidden;}
...
div.video_box1{vertical-align:top;float:left;text-align:left;width:55px;padding-right:6px;overflow:hidden;z-index:-10000;}
...
div.video_screen{width:417px;overflow:hidden;z-index:10;}
...
div.display_image_right{float:right;width:490px;padding:19px;z-index:20;}
div.display_image_top{position:absolute;background-color:white;padding:6px;padding-bottom:5px;width:578px;}
div.display_image_bottom{position:absolute;background-color:white;padding:6px;width:578px;bottom:0px;height:13px;text-align:left;overflow:hidden;}
