...
while($row = mysql_fetch_array($mysql))
	...
	$FF_Notes = join(',',$FF_array2);}
	
////////// NOTES!!! //////////
$mysql1 = mysql_query("SELECT * FROM notes WHERE user_id IN ($FF_Notes) AND delete_item='1' ORDER BY note_date DESC LIMIT ".$number.",20");
...
$(window).data('ajaxready3', true).scroll(function(e)
	...
	if($(window).scrollTop()>=$(document).height()-$(window).height())
		...
		$.ajax({cache: false,url:"note_content.php?number="+number+"&cacheBuster="+cacheBuster+"&id="+id+"&ids="+ids,
