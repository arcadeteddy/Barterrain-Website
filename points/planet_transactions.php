...
<div class="points_sub_body" id="points_sub_body">
	<div class="bottom_point_transactions">
		<?php $mysql_union = mysql_query("(SELECT * FROM point_transactions WHERE (plus_id='$ids' OR minus_id='$ids') AND delete_transaction='1' AND create_type='planet') 
        ...
        <div id="bottom_planet_transactions">
			<?php include "planet_transactions_content.php"; ?>
        </div>
